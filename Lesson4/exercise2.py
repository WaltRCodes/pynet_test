...
def main():
    ...
    push_command(remote_conn, cmd='conf t')
    push_command(remote_conn, cmd='logging buffered 20010')
    push_command(remote_conn, cmd='end')

    nextoutput = push_command(remote_conn, cmd='show run | inc logging', delay=2)
    print('\n')
    print(nextoutput)
    print('\n')
